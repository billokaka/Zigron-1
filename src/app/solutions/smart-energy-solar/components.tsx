  ...
  return (
    <div className="bg-white dark:bg-surface-dark p-8 md:p-10 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-md p-3 text-sm focus:ring-yellow-500 focus:border-yellow-500 outline-none transition"
          />
        </div>
        <div>
          <label className="block text-xs font-bold text-gray-500 mb-2 uppercase tracking-wider">
      ...
      <div className="mb-8">
        ...
        <textarea
          placeholder="Describe your solar portfolio, current challenges, and goals..."
          rows={4}
          className="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-md p-3 text-sm focus:ring-yellow-500 focus:border-yellow-500 outline-none transition resize-none"
        ></textarea>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="text-center">
          <span className="text-xs text-gray-400">
            Or email us at{" "}
            <a href={`mailto:${email}`} className="text-yellow-500 hover:underline">
              {email}
            </a>
          </span>
        </div>
