...
import { ChevronDown, Settings, Shield, CheckCircle, Zap, Search, Database, Workflow, Target, Layers, Cpu, Cloud, BarChart, AlertTriangle, Wrench, Activity, Eye, type LucideIcon } from "lucide-react";
...
export function getIcon(iconName: IconName): LucideIcon { return iconMap[iconName] || Settings; }
