...
import { ChevronDown, Home, Shield, CheckCircle, Zap, Search, Database, Workflow, Target, Layers, Cpu, Cloud, Smartphone, Wifi, Lock, Eye, Settings, type LucideIcon } from "lucide-react";
