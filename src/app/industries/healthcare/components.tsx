...
import { ChevronDown, Heart, Shield, Cpu, BarChart, Lock, Clock, Clipboard, AlertTriangle, Database, Cloud, Users, Target, Zap, Activity, FileText, Eye, type LucideIcon } from "lucide-react";
import type { FAQ, IconName } from "./data";

const iconMap: Record<IconName, LucideIcon> = { heart: Heart, shield: Shield, cpu: Cpu, barChart: BarChart, lock: Lock, clock: Clock, clipboard: Clipboard, alertTriangle: AlertTriangle, database: Database, cloud: Cloud, users: Users, target: Target, zap: Zap, activity: Activity, fileText: FileText, eye: Eye };
