...
import { ChevronDown, Truck, Shield, Cpu, BarChart, Lock, Clock, Clipboard, AlertTriangle, Database, Wifi, Cloud, Users, Target, Zap, MapPin, Navigation, type LucideIcon } from "lucide-react";
import type { FAQ, IconName } from "./data";

const iconMap: Record<IconName, LucideIcon> = { truck: Truck, shield: Shield, cpu: Cpu, barChart: BarChart, lock: Lock, clock: Clock, clipboard: Clipboard, alertTriangle: AlertTriangle, database: Database, wifi: Wifi, cloud: Cloud, users: Users, target: Target, zap: Zap, mapPin: MapPin, navigation: Navigation };
export function getIcon(iconName: IconName): LucideIcon { return iconMap[iconName] || Truck; }
