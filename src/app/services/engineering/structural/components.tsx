...
import { ChevronDown, Building, Mountain, Shield, CheckCircle, Zap, Ruler, Calculator, Compass, Layers, Target, Search, Wind, Sun, Database, Workflow, PenTool, type LucideIcon } from "lucide-react";
...
export function getIcon(iconName: IconName): LucideIcon { return iconMap[iconName] || Building; }
