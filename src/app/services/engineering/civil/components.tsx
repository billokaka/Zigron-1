...
import { ChevronDown, Building, Mountain, Shield, CheckCircle, Zap, Ruler, Calculator, Compass, Layers, Target, Search, Wind, Droplets, Database, Workflow, PenTool, MapPin, Sun, type LucideIcon } from "lucide-react";
...
export function getIcon(iconName: IconName): LucideIcon { return iconMap[iconName] || MapPin; }
