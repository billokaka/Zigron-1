// Identity & Access Management Page - SSR
                    ...
                    <Container>
                        <div className="mb-14">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark max-w-2xl text-lg">
                                Identity and access management for humans, machines, and APIs.
                            </p>
                        </div>
                ...
                <Section>
                    <Container>
                        <div className="mb-16 text-center">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark">
                                Layered identity from directory to governance.
                            </p>
                        </div>
                    ...
                    <Container>
                        <div className="flex flex-col items-center mb-16">
                            ...
                            <p className="text-text-muted-light dark:text-text-muted-dark max-w-2xl text-center">
                                Vendor-agnostic identity infrastructure we implement and manage.
                            </p>
                        </div>
                            ...
                            {caseStudies.map((study) => (
                                ...
                                >
                                    <div className="h-52 bg-gray-900 relative overflow-hidden flex items-center justify-center">
                                        ...
                                        <Users className="w-16 h-16 text-teal-500 opacity-80 group-hover:scale-110 transition-transform duration-500" />
