// DevSecOps & Secure CI/CD Page - SSR
                ...
                >
                    <Container>
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            {/* Hero Visual - Pipeline Security Abstract */}
                            ...
                            {caseStudies.map((study) => (
                                ...
                                >
                                    <div className="h-52 bg-gray-900 relative overflow-hidden flex items-center justify-center">
                                        ...
                                        <Terminal className="w-16 h-16 text-teal-500 opacity-80 group-hover:scale-110 transition-transform duration-500" />
