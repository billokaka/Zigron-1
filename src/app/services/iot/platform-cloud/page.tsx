// IoT Platform & Cloud Service Page - SSR
// Build or modernize IoT backend platforms at scale
...
export default function IoTPlatformCloudPage() {
    return (
        <>
            <Header />
                    ...
                    <Container>
                        <div className="mb-14">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark max-w-2xl text-lg">
                                Production-ready platform components, fully documented and
                                designed for your specific scale and operational requirements.
                            </p>
                        </div>
                        ...
                        <div className="flex justify-between items-end mb-14">
                            <div>
                                ...
                                <p className="mt-4 text-text-muted-light dark:text-text-muted-dark">
                                    Platforms built for operators demanding scale, reliability, and cost control.
                                </p>
                            </div>
                            <a
                                href="/industries"
                    ...
                    <Container>
                        ...
                        <div className="mt-16 p-8 bg-white dark:bg-background-dark border border-gray-200 dark:border-gray-700 rounded text-center max-w-3xl mx-auto shadow-sm">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                ...
                                to augment your staff or a complete{" "}
                                <span className="text-primary font-bold">
                ...
                <Section>
                    <Container>
                        <div className="mb-16 text-center">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark">
                                Built on solid engineering principles for long-term scalability and cost efficiency.
                            </p>
                        </div>
                    ...
                    <Container>
                        <div className="flex flex-col items-center mb-16">
                            ...
                            <p className="text-text-muted-light dark:text-text-muted-dark max-w-2xl text-center">
                                We select the best-in-class tools for every layer of the stack to
