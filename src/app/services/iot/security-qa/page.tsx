// IoT Security & QA Service Page - SSR
// End-to-end security and quality assurance for IoT systems
...
export default function IoTSecurityQAPage() {
    return (
        <>
            <Header />
                    ...
                    <Container>
                        <div className="mb-14">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark max-w-2xl text-lg">
                                Comprehensive security and quality assurance designed for
                                real-world IoT failure modes and attack surfaces.
                            </p>
                        </div>
                    ...
                    <Container>
                        ...
                        <div className="mt-16 p-8 bg-white dark:bg-background-dark border border-gray-200 dark:border-gray-700 rounded text-center max-w-3xl mx-auto shadow-sm">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">
                                ...
                                , we adapt to your threat landscape.
                            </p>
                        </div>
                    </Container>
                </Section>
                    ...
                    <Container>
                        <div className="flex flex-col items-center mb-16">
                            ...
                            <p className="text-text-muted-light dark:text-text-muted-dark max-w-2xl text-center">
                                Industry-standard tools for security hardening, testing
