// IoT Product Engineering Service Page - SSR
// End-to-end IoT product development for OEMs and Enterprises
...
export default function IoTProductEngineeringPage() {
  return (
    <>
      <Header />
          ...
          <Container>
            <div className="mb-14">
              ...
              <p className="mt-4 text-text-muted-light dark:text-text-muted-dark max-w-2xl text-lg">
                We deliver complete intellectual property and production-ready
                assets tailored to your specific engineering requirements.
              </p>
            </div>
            ...
            <div className="flex justify-between items-end mb-14">
              <div>
                ...
                <p className="mt-4 text-text-muted-light dark:text-text-muted-dark">
                  Solving complex problems for industries demanding high reliability.
                </p>
              </div>
              <a
                href="/industries"
        ...
        <Section>
          <Container>
            <div className="mb-16 text-center">
              ...
              <p className="mt-4 text-text-muted-light dark:text-text-muted-dark">
                Built on solid engineering principles for long-term viability.
              </p>
            </div>
