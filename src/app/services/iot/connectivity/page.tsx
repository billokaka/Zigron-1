// IoT Connectivity & Integration Page - SSR
    ...
    return (
                ...
                >
                    <Container>
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            {/* Hero Visual - Connectivity Radar Abstract */}
                            <div className="relative h-[450px] w-full flex items-center justify-center bg-gray-900 rounded border border-gray-700 p-8 shadow-2xl overflow-hidden">
                                ...
                                ></div>
                                {/* Radar Pulse */}
                                <div className="absolute w-[600px] h-[600px] rounded-full border border-blue-500/20 animate-[ping_3s_linear_infinite]"></div>
                                <div className="absolute w-[400px] h-[400px] rounded-full border border-blue-500/30 animate-[ping_3s_linear_infinite_1s]"></div>
                                <div className="absolute w-[200px] h-[200px] rounded-full border border-blue-500/40 animate-[ping_3s_linear_infinite_0.5s]"></div>

                                {/* Icons connected */}
                                <div className="relative z-10 w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(59,130,246,0.5)]">
                                ...
                                <div className="absolute bottom-10 left-32 bg-gray-800 p-2 rounded-full border border-gray-600">
                                    <Router className="w-6 h-6 text-gray-400" />
                                </div>
                            </div>
                        </div>
                    </Container>
                    ...
                    <Container>
                        <div className="mb-14">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark max-w-2xl text-lg">
                                RF Engineering and custom antenna design.
                            </p>
                        </div>
                ...
                <Section>
                    <Container>
                        <div className="mb-16 text-center">
                            ...
                            <p className="mt-4 text-text-muted-light dark:text-text-muted-dark">
                                Full stack connectivity management.
                            </p>
                        </div>
                    ...
                    <Container>
                        <div className="flex flex-col items-center mb-16">
                            ...
                            <p className="text-text-muted-light dark:text-text-muted-dark max-w-2xl text-center">
                                We are carrier and hardware agnostic.
                            </p>
                        </div>
                            ...
                            {caseStudies.map((study) => (
                                ...
                                >
                                    <div className="h-52 bg-gray-900 relative overflow-hidden flex items-center justify-center">
                                        ...
                                        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "repeating-linear-gradient(45deg, transparent, transparent 10px, #3b82f6 10px, #3b82f6 20px)" }}></div>
                                        <Wifi className="w-16 h-16 text-blue-500 opacity-80 group-hover:scale-110 transition-transform duration-500" />
        ...
        ================================================================ */}
                <Section className="relative overflow-hidden">
                    <div className="absolute -right-20 -top-20 w-96 h-96 bg-blue-100 dark:bg-blue-900 rounded-full opacity-20 blur-3xl pointer-events-none"></div>
