...
function getIconServer(name: IconName): LucideIcon { return iconMap[name] || Cpu; }
    ...
    return (
        <>
            ...
            <main>
                                ...
                                <div className="relative w-full max-w-md z-10">
                                    <div className="flex flex-col justify-between items-center relative h-80">
                                        ...
                                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 flex items-center gap-4 w-64 relative">
                                            <div className="w-10 h-10 bg-blue-50 dark:bg-blue-900/30 rounded flex items-center justify-center text-blue-600"><Zap className="w-6 h-6" /></div>
                                            <div><div className="text-xs text-primary font-bold uppercase mb-0.5">Output</div><div className="text-sm font-semibold dark:text-white">Fast Inference</div></div>
                                        ...
                                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border-2 border-primary flex items-center gap-4 w-72 z-20 scale-110">
                                            <div className="w-12 h-12 bg-primary text-white rounded flex items-center justify-center shadow-lg"><Cpu className="w-7 h-7" /></div>
                                            <div><div className="text-xs text-gray-400 font-bold uppercase mb-0.5">Core</div><div className="text-base font-bold dark:text-white">Edge Optimization</div></div>
                                        </div>
                                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 flex items-center gap-4 w-64 relative">
                                            ...
                                            <div><div className="text-xs text-primary font-bold uppercase mb-0.5">Input</div><div className="text-sm font-semibold dark:text-white">Trained Model</div></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <Section>
                    <Container>
                        <div className="flex justify-between items-end mb-14">
                            <div><span className="text-primary font-bold uppercase tracking-widest text-sm">Use Cases</span><h2 className="text-3xl font-bold mt-2 text-black dark:text-white">Who Is This For?</h2><p className="mt-4 text-text-muted-light dark:text-text-muted-dark">Teams whose models are too slow, too expensive, or stuck in the cloud.</p></div>
                ...
                <Section background="surface">
                    <Container>
                        ...
                        <div className="mt-16 p-8 bg-white dark:bg-background-dark border border-gray-200 dark:border-gray-700 rounded text-center max-w-3xl mx-auto shadow-sm">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Whether you need a <span className="text-primary font-bold">Full Edge Deployment</span> or <span className="text-primary font-bold">Cloud Inference Optimization</span>, we adapt to your hardware and cost constraints.</p>
                        </div>
                    </Container>
                </Section>
                ...
                <Section>
                    <Container>
                        <div className="mb-16 text-center"><span className="text-primary font-bold uppercase tracking-widest text-sm">Architecture</span><h2 className="text-3xl font-bold mt-2 text-black dark:text-white">Technical Approach</h2><p className="mt-4 text-text-muted-light dark:text-text-muted-dark">From trained model to optimized edge deployment.</p></div>
                ...
                <Section background="surface">
                    <Container>
                        <div className="flex flex-col items-center mb-16"><h3 className="text-3xl font-bold mb-4 text-black dark:text-white">Tools & Technologies</h3><p className="text-text-muted-light dark:text-text-muted-dark max-w-2xl text-center">Hardware-aware optimization for any deployment target.</p></div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {caseStudies.map((s) => (
                                <div key={s.title} className="bg-white dark:bg-surface-dark rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow border border-gray-100 dark:border-gray-800 flex flex-col group">
                                    <div className="h-52 bg-gray-200 dark:bg-gray-700 relative overflow-hidden"><div className="absolute inset-0 bg-gradient-to-br from-gray-600 to-gray-800 group-hover:scale-105 transition-transform duration-500"></div><div className="absolute top-4 left-4 bg-white/95 dark:bg-black/80 px-3 py-1 text-xs font-bold rounded uppercase tracking-wider">Edge AI</div></div>
