...
import { ArrowRight, Brain, Eye, Search, Layers, Target, Cpu, Zap, Shield, BarChart3, CheckCircle, Database, Cloud, Workflow, Sparkles, Lock, type LucideIcon } from "lucide-react";
...
const iconMap: Record<IconName, LucideIcon> = { brain: Brain, eye: Eye, search: Search, layers: Layers, target: Target, cpu: Cpu, zap: Zap, shield: Shield, barChart: BarChart3, checkCircle: CheckCircle, database: Database, cloud: Cloud, workflow: Workflow, sparkles: Sparkles, lock: Lock };
function getIconServer(name: IconName): LucideIcon { return iconMap[name] || Workflow; }
        ...
        <>
            ...
            <main>
                                ...
                                <div className="relative w-full max-w-md z-10">
                                    <div className="flex flex-col justify-between items-center relative h-80">
                                        ...
                                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 flex items-center gap-4 w-64 relative">
                                            <div className="w-10 h-10 bg-blue-50 dark:bg-blue-900/30 rounded flex items-center justify-center text-blue-600"><BarChart3 className="w-6 h-6" /></div>
                                            <div><div className="text-xs text-primary font-bold uppercase mb-0.5">Output</div><div className="text-sm font-semibold dark:text-white">Monitored Models</div></div>
                                        ...
                                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border-2 border-primary flex items-center gap-4 w-72 z-20 scale-110">
                                            ...
                                            <div><div className="text-xs text-gray-400 font-bold uppercase mb-0.5">Core</div><div className="text-base font-bold dark:text-white">ML Pipeline</div></div>
                                        </div>
                                        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border border-gray-200 dark:border-gray-600 flex items-center gap-4 w-64 relative">
                                            ...
                                            <div className="w-10 h-10 bg-green-50 dark:bg-green-900/30 rounded flex items-center justify-center text-green-600"><Brain className="w-6 h-6" /></div>
                                            <div><div className="text-xs text-primary font-bold uppercase mb-0.5">Input</div><div className="text-sm font-semibold dark:text-white">Trained Models</div></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <Section background="surface" border="both">
                    <Container>
                        <div className="mb-14"><span className="text-primary font-bold uppercase tracking-widest text-sm">Deliverables</span><h2 className="text-3xl font-bold mt-2 text-black dark:text-white">What You Get With Zigron</h2><p className="mt-4 text-text-muted-light dark:text-text-muted-dark max-w-2xl text-lg">ML infrastructure that gets models from notebooks to production—and keeps them running.</p></div>
                ...
                <Section>
                    <Container>
                        <div className="flex justify-between items-end mb-14">
                            <div><span className="text-primary font-bold uppercase tracking-widest text-sm">Use Cases</span><h2 className="text-3xl font-bold mt-2 text-black dark:text-white">Who Is This For?</h2><p className="mt-4 text-text-muted-light dark:text-text-muted-dark">Teams with great models stuck in notebooks.</p></div>
                ...
                <Section background="surface">
                    <Container>
                        ...
                        <div className="mt-16 p-8 bg-white dark:bg-background-dark border border-gray-200 dark:border-gray-700 rounded text-center max-w-3xl mx-auto shadow-sm">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Whether you need a <span className="text-primary font-bold">Full MLOps Platform Build</span> or <span className="text-primary font-bold">Model Deployment Consulting</span>, we adapt to your ML maturity level.</p>
                        </div>
                    </Container>
                </Section>
                ...
                <Section>
                    <Container>
                        <div className="mb-16 text-center"><span className="text-primary font-bold uppercase tracking-widest text-sm">Architecture</span><h2 className="text-3xl font-bold mt-2 text-black dark:text-white">Technical Approach</h2><p className="mt-4 text-text-muted-light dark:text-text-muted-dark">End-to-end model lifecycle from training to production monitoring.</p></div>
                ...
                <Section background="surface">
                    <Container>
                        <div className="flex flex-col items-center mb-16"><h3 className="text-3xl font-bold mb-4 text-black dark:text-white">Tools & Technologies</h3><p className="text-text-muted-light dark:text-text-muted-dark max-w-2xl text-center">Best-in-class tools for ML pipelines, serving, and monitoring.</p></div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {caseStudies.map((s) => (
                                <div key={s.title} className="bg-white dark:bg-surface-dark rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow border border-gray-100 dark:border-gray-800 flex flex-col group">
                                    <div className="h-52 bg-gray-200 dark:bg-gray-700 relative overflow-hidden"><div className="absolute inset-0 bg-gradient-to-br from-gray-600 to-gray-800 group-hover:scale-105 transition-transform duration-500"></div><div className="absolute top-4 left-4 bg-white/95 dark:bg-black/80 px-3 py-1 text-xs font-bold rounded uppercase tracking-wider">MLOps</div></div>
