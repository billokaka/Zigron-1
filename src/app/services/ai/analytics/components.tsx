...
import { ChevronDown, Brain, Eye, Search, Layers, Target, Cpu, Zap, Shield, BarChart3, CheckCircle, Database, Cloud, Workflow, Sparkles, Lock, TrendingUp, LineChart, type LucideIcon } from "lucide-react";
...
export function getIcon(iconName: IconName): LucideIcon { return iconMap[iconName] || BarChart3; }
